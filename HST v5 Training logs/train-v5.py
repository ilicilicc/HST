...
if __name__ == '__main__':
    ...
    try:
        ...
        LOCAL_CHECKPOINT_PATH = '/content/hst_v5_checkpoints/hst_v5_step_200.pt'
        if os.path.exists(LOCAL_CHECKPOINT_PATH):
            ...
            CHECKPOINT_PATH = f'/content/drive/MyDrive/hst_v5_checkpoints/hst_v5_step_200.pt'
            DRIVE_MOUNTED = True
    except ImportError:
        CHECKPOINT_PATH = './hst_v5_checkpoints/hst_v5_step_200.pt'
        DRIVE_MOUNTED = False
