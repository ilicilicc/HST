...
# ==========================================================
# 3. FULL HST-v5.2 UNIFIED MODEL
# ==========================================================
class HSTv5_2Unified(nn.Module):
    def __init__(
        self,
        vocab_size,
        d_model,
...
if __name__ == '__main__':
    print("=" * 70)
    print("HST-v5.2 UNIFIED (Token and Chunk Mode)")
    print("=" * 70)

    # Test Token Mode
    print("\n--- Testing Token Mode ---")
    model_token = HSTv5_2Unified(
        vocab_size=50257,
        d_model=256,
        n_heads=4,
        n_layers=8,
